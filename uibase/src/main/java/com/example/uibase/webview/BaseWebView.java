...
public class BaseWebView extends WebView implements BaseWebViewClient.WebviewTouch{
    ...
    private BaseWebViewCallBack webViewCallBack;
    private Map<String, String> mHeaders;
    private BaseWebViewJavascriptInterface remoteInterface = null;
    ...
    public void registerWebViewCallBack(BaseWebViewCallBack webViewCallBack) {
    ...
    protected void init(Context context) {
        ...
        webviewClient = new BaseWebViewClient(this, webViewCallBack, mHeaders, this);
        ...
        if (remoteInterface == null) {
            remoteInterface = new BaseWebViewJavascriptInterface(context);
            remoteInterface.setJavascriptCommand(new BaseWebViewJavascriptInterface.JavascriptCommand() {
                @Override
