...
import com.example.uibase.webview.BaseWebViewCallBack;

import java.util.Map;

import static com.example.uibase.webview.BaseWebView.CONTENT_SCHEME;
...
public class BaseWebViewClient extends WebViewClient {
    ...
    public BaseWebViewClient(WebView webView, BaseWebViewCallBack webViewCallBack, Map<String, String> headers, WebviewTouch touch){
