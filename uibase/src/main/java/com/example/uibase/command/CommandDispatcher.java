...
import com.example.uibase.mainprocess.RemoteWebBinderPool;
import com.example.uibase.utils.MainLooper;
import com.example.uibase.utils.SystemInfoUtil;
import com.example.uibase.utils.WebConstants;
import com.example.uibase.webview.BaseWebView;
...
/*    public IWebAidlInterface getWebAidlInterface(Context context) {
    ...
    private void execRemoteCommand(Context context, int commandLevel, String cmd, String params, final WebView webView, final DispatcherCallBack dispatcherCallBack) throws Exception {
        ...
        if (SystemInfoUtil.inMainProcess(context, android.os.Process.myPid())) {
            ...
            if (webAidlInterface != null) {
                webAidlInterface.handlerWebAction(commandLevel, cmd, params, new IWebAidlCallback.Stub() {
                    @Override
