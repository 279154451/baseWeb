package com.example.base.binder;
...
import com.example.base.service.ServiceMethod;
import com.example.base.service.ServiceProvider;
import com.example.base.util.ParamUtil;
...
public class MethodRouter {
    ...
    public static Object routerToProvider(String name, Bundle argsBundle) {
        Bundle bundle = ContentProviderCompat.call(ServiceProvider.buildUri(), ServiceMethod.CALL_SERVICE.getMethod(), name, argsBundle);
        return ParamUtil.getResult(bundle);
    }
